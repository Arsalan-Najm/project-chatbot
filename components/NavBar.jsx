...
const NavBar = () => {
  ...
  return (
    <header
      className={`2xl:max-w-[1280px] z-50 w-full flex justify-between items-center gap-8 mx-auto sm:p-8 xs:p-8 px-2 py-3 ${
        session && status === 'authenticated' ? '2xl:max-w-full bg-main-200 drop-shadow-sm' : 'absolute left-0 right-0'
      }`}
    >
